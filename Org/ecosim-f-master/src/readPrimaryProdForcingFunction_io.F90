...
use statevartypesecosim, only: PrimaryProdForcing_fname, nvars, &
                         PrimaryProdForce, producer_no, nproducer
...
do i = 1, frows
    read(555, *, end = 500) dummy, PrimaryProdForce(i, :)
end do

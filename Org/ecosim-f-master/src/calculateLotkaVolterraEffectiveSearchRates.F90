...
do var = 1, nvars
    ...
    !WRITE(*,*) 'es_htime', es_data(var)%htime
    !WRITE(*,*) 'es_pred', es_data(var)%pred
    !WRITE(*,*) 'es_QB_maxoQB_0', es_data(var)%QB_maxoQB_0
    !WRITE(*,*) 'es_biomass', ep_data(var)%biomass
    !WRITE(*,*) 'ep_QoB', ep_data(var)%QoB
end do

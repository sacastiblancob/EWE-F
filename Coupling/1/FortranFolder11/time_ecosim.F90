...
! IN SUBROUTINE VARIABLES
  ...
  REAL(SELECTED_REAL_KIND(15,307)) :: CCOUN, SUIT
!  REAL(SELECTED_REAL_KIND(15,307)) :: ECOSUI_GRID(nlat,nlon,nvars)  !Ecosuitability in ecospace grid
...
!       do n = 1, StepsPerMonth
        ...
        !              BB_spatial, advection, ECOSUI_GRID)
        call ecospace(nvars, nlat, nlon, lat, lon, time, BBeco, &
                      ep_data, es_data, grid, QperB, M2, &

...
! MODIFIED
!      USE DECLARATIONS_WAQTEL, ONLY : WAQPROCESS, IND_ECO, ISECO
! PAR ADDED BY SERGIO
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! PART ADDEDD BY SERGIO
! MODIFYING THE ICONVFT FOR TRACERS IN ECOSPACE
! UNFORTUNATELY THIS DOES NOT WORK - OPTION 0 IS NOT IMPLEMENTED :(
! WATCH http://www.opentelemac.org/index.php/assistance/forum5/16-telemac-2d/10833-tracer-advection-activation-iconvf-in-t2d-v7p2
!       IF(ISECO) THEN
!         DO I = 1,nvars
!           ICONVFT(IND_ECO(I)) = 0
!         ENDDO

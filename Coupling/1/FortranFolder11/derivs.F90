...
!!                         NutrientForce, detritus_no, boolFN, boolFPP, &
!!                         ndetritus, FirstTime
use statevartypesecosim, only: ecosim_data, arena_data, NutrientForce
...
! set relative prey switching
 call setRelativeSwitchingParameters(nvars, vrows, vcols, biomass, &
                                      es_data, es_vul, arena)

! vulnerability calculations
 call calculateVulnerableBiomasses(nvars, vrows, vcols, biomass, &
                                    es_data, es_vul, arena)
...
! detritus calculations
 call calculateDetritalFlows(nvars, detritus_no, ndetritus, FirstTime, &
                              ep_data, ep_detfate, flow2detritus, det_export_rate, &
                              biomass, es_data)

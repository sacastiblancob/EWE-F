...
!========================================================================
              ...
              subroutine calculateDetritalFlows &
  (nvars, detritus_no, ndetritus, FirstTime, ep_data, ep_detfate, &
   flow2detritus, det_export_rate, biomass, es_data)
...
! INTENT VARIABLES
INTEGER, INTENT(IN)            :: nvars, ndetritus
...
REAL(RLEN), INTENT(INOUT)      :: flow2detritus(ndetritus)
REAL(RLEN), INTENT(OUT)        :: det_export_rate(ndetritus)
